...
import { DesigeProgramData } from "@/data/data";

// Contents
import DesigeprogramIns from "/src/assets/instructor/kajana-150x150.jpg";

export default function Desigeprogram() {
	return (
		<div>
			<Head>
				<title>Desigeprogram</title>
				...
				<Card>
					<div className="condiv home">
						<Typography component="h1" variant="h4" textAlign="center" mt={5}>
							งาน หลักการออกแบบและเขียนโปรแกรมคอมพิวเตอร์ ที่ต้องทำ
						</Typography>
						<Typography component="h1" variant="h5" textAlign="center">
							รหัสวิชา COM 1505-63
						</Typography>
						<Typography component="h1" variant="h5" textAlign="center">
						...
						<Grid container p={5}>
							...
							<Grid item container md={6} p={5}>
								<Grid container spacing={4} p={5}>
									{DesigeProgramData.map((item, index) => (
